...
max_seq = 1
for el in li_num:
    if len_seq(el, li_num) > max_seq:
        max_seq = len_seq(el, li_num)
        min_el = el
max_li = []
max_li.append(min_el)
max_li.append(min_el+max_seq-1)

print('Список чисел', li_num)
print(f'Макс.последовательность: {max_seq}')
